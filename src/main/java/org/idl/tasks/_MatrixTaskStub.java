...
public class _MatrixTaskStub extends org.omg.CORBA.portable.ObjectImpl implements MatrixTask
{

  public int getMatrixItem (int row, int col) throws TaskException
  {
