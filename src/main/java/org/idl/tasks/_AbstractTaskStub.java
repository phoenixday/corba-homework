...
public class _AbstractTaskStub extends org.omg.CORBA.portable.ObjectImpl implements org.idl.tasks.AbstractTask
{
  ...
  public org.idl.tasks.AbstractTask next () throws TaskException
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("next", true);
                $in = _invoke ($out);
                org.idl.tasks.AbstractTask $result = org.idl.tasks.AbstractTaskHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
